...
check('AGORA_ENV valid', ['dev', 'staging', 'prod'].includes(ENV), ENV);
check('PUBLIC_BASE_URL', !!process.env.PUBLIC_BASE_URL, process.env.PUBLIC_BASE_URL ? 'set' : 'missing — webhooks will not be verifiable');
